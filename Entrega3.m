...
c(3).name = 'knn';c(3).options.k=3;% K-NN
c(4).name= 'nnglm';c(4).options.iter=15; c(4).options.method= 1;% Red Neuronal
...
% valores de presición y matrices de confusion
